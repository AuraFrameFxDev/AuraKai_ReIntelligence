...
buildscript {
    ...
    dependencies {
        ...
        classpath("org.jetbrains.kotlin:kotlin-gradle-plugin:${libs.findVersion("kotlin").get()}")
        classpath(
        ...
        classpath("org.jetbrains.kotlin:kotlin-serialization:${libs.findVersion("kotlin").get()}")
